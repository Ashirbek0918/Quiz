...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        @include('participants.layouts.menu')
        <!--================================-->
        <!-- Sidebar Footer Start -->
        <!--================================-->
        <div class="sidebar-footer d-flex justify-content-around">
            <a class="pull-left" href="#" data-toggle="tooltip" data-placement="top"
...
{{--                <i class="icon-lock"></i></a>--}}
    ...
    <div class="page-content ht-100v">
        ...
        <!-- Page Header Start -->
        <!--================================-->
        @include('participants.layouts.navbar')
        <!--/ Page Header End -->
        <!--================================-->
        <!-- Page Inner Start -->
        <!--================================-->
...
{{--         ht-100v--}}
         ">
            ...
            <div id="main-wrapper">
                ...
                <!-- Breadcrumb Start -->
                <!--================================-->
                {{--                @include('participants.layouts.page_breadcrumb')--}}
                {{--                <!--/ Breadcrumb End -->--}}
                @yield('content')
{{--                @dd(app()->getLocale())--}}
            </div>
...
<!--================================-->
{{--@include('admin.participants.layouts.color_switcher')--}}
<!--/ Color switcher  End  -->
<!--================================-->
<!-- Scroll To Top Start-->
<!--================================-->
